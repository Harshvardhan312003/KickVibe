...
const BootsPage = () => {
  ...
  useEffect(() => {
    const fetchBoots = async () => {
      try {
        const response = await getAllShoes({ category: 'boots', limit: 100 });
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="mt-6 text-lg text-(--text-color)/85 leading-relaxed">
                Explore our collection of durable and stylish boots. Perfect for any weather, combining comfort with rugged sophistication.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <>
              ...
              >
                <p className="text-lg text-(--text-color)/75">
                  {isLoading ? 'Loading...' : `${shoes.length} ${shoes.length === 1 ? 'boot' : 'boots'} available`}
                </p>
              ...
              {!isLoading && shoes.length === 0 && (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-(--text-color) mb-2">No Boots Found</h3>
